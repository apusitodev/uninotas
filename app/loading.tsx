...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#f4f5f8]/90 backdrop-blur-sm">
      <div className="flex flex-col items-center space-y-4 p-8 rounded-3xl bg-white shadow-2xl border border-gray-100 max-w-xs w-full mx-4">
        ...
        {/* Contenedor de la botella animada */}
        <div className="flex items-center justify-center my-1">
          <svg
            viewBox="0 0 205 615"
            className="w-[45px] h-[90px] animate-pulse stroke-[#0071e3] fill-transparent stroke-[16px] stroke-linecap-round"
          >
        ...
        {/* Textos con Sincronizando expediente... debajo */}
