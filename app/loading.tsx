  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#f4f5f8]">
      <div className="flex flex-col items-center space-y-4 p-8 rounded-3xl bg-white shadow-xl border border-gray-100 max-w-xs w-full mx-4">
        ...
        {/* Botella de la marca animada */}
        <div className="flex items-center justify-center my-2">
          <svg
            viewBox="0 0 205 615"
            className="cola w-[42px] fill-transparent stroke-gray-900 stroke-[16px] stroke-linecap-round"
          >
          ...
          <style jsx>{`
            .cola {
              ...
              animation: loader 7s cubic-bezier(0.5, 0.1, 0.5, 1) infinite both;
            }
