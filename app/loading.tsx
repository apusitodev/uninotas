  ...
  return (
    <div className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#f4f5f8]">
      <div className="flex flex-col items-center space-y-4 p-8 rounded-3xl bg-white shadow-2xl border border-gray-100 max-w-xs w-full mx-4">
        ...
        {/* Aquí va tu animación original de la botella */}
        <div className="flex items-center justify-center py-2">
          <svg
            viewBox="0 0 205 615"
            className="cola w-[40px] fill-transparent stroke-gray-900 stroke-[15px] stroke-linecap-round"
          >
          ...
          <style jsx>{`
            .cola {
              ...
              animation: loader 6s cubic-bezier(0.5, 0.1, 0.5, 1) infinite both;
            }
