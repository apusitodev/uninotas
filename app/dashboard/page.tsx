...
export default function DashboardPage() {
  ...
  const getSubjectGrade = (subjectId: string) => {
    ...
    return {
      ...
      scaledToTen: evaluatedWeight > 0 ? Number((weightedSum / (evaluatedWeight / 100)).toFixed(2)) : 0,
    ...
    return (
      <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#f4f5f8]">
        <div className="flex flex-col items-center space-y-4 p-8 rounded-3xl bg-white shadow-xl border border-gray-100 max-w-xs w-full mx-4">
          ...
          {/* Contenedor de la botella con animación y color azul corporativo */}
    ...
    <div className="min-h-screen bg-[#f4f5f8] text-gray-900 font-sans antialiased relative overflow-x-hidden">
      ...
      <div className={`border-t border-gray-200/60 pt-4 space-y-2.5 ${sidebarOpen ? 'animate-ios-item-4' : ''}`}>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-red-50 hover:bg-red-100 text-red-600 font-semibold text-xs transition-colors cursor-pointer"
                >
                ...
                <div className="w-full pt-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-gray-100 hover:bg-gray-200/80 text-xs font-semibold text-gray-700 transition-colors cursor-pointer md:hidden"
                  >
